...
import static online_store_app.config.Constans.DELETE_URI;
import static online_store_app.config.Constans.DOWNLOAD_URI;

@Service
public class LocalFileService {
    private String uploads = "C:\\webfile\\files\\";
